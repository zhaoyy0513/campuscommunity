...
CREATE TABLE `post`  (
  `id` int(20) NOT NULL DEFAULT 0 COMMENT '帖子id',
...
-- Records of post
-- ----------------------------
INSERT INTO `post` VALUES (1, '吹不散眉弯', '找找一份实习工作', 14, '实习', 2, '本人软件学院的一名15级学生，想要找一份软件工程,java方向的工作，有没有大佬能够帮我引荐一下，或者推荐一下工作什么的啊，非常感谢啊。', '2019-03-29 10:34:51', '226ce810-c32d-4ce5-993f-3986ee9aad06.PNG', '', 93, 0, 'root', '2019-04-04 14:27:28', '4天19小时4分钟之前');
INSERT INTO `post` VALUES (2, '吹不散眉弯', '今天学到了一点新的东西，跟同学们分享一下', 9, '工学', 1, '今天学习了设计模式，发现里面很多东西都非常值得思考，今天刚刚学习了策略模式，感觉非常不错，希望大家都可以学习一下，', '2019-03-29 10:38:08', '51d89138-372b-42e7-91c9-78afef1c52a3.PNG', '', 248, 6, 'root', '2019-04-09 09:55:55', '8天1小时32分钟之前');
INSERT INTO `post` VALUES (3, '吹不散眉弯', '谈谈今天的一些感受吧', 9, '工学', 1, '今天温度挺低的，本来就穿的不厚，结果感觉今天脑子更疼， 不知道大家有没有啥推荐的网站听听音乐啥的吗,http://www.baidu.com', '2019-04-01 09:07:44', 'ab35664c-3d1d-4046-98de-5e3de09ce992.PNG', '', 45, 2, '一首歌从深情唱', '2019-04-08 18:06:20', '8天17小时22分钟之前');
INSERT INTO `post` VALUES (4, 'root', 'B 站的同学，你们能不能不要在移动端主页投毒了？', 10, '理学', 1, '每次手机重装系统之后去 B 站主页( https://m.bilibili.com/index.html) 下客户端，都会下到国际版。只能安装客户端后去问客服要国内的客户端，再重新装一次。​为什么移动端首页不能改成国内的？国际版的没有免流服务，我要它何用？', '2019-04-01 09:09:08', '', '', 35, 2, '吹不散眉弯', '2019-04-09 09:08:22', '8天2小时20分钟之前');
INSERT INTO `post` VALUES (5, '吹不散眉弯', '测试下管理学代码', 12, '管理学', 1, '如果管理学代码测试成功！，那么今天就完成了很大的一部分工作！加油 2019/4/1', '2019-04-01 11:27:28', '', NULL, 101, 1, '一首歌从深情唱', '2019-04-04 14:27:28', '12天21小时1分钟之前');
INSERT INTO `post` VALUES (6, '吹不散眉弯', '理学的二次测试', 10, '理学', 1, '如果这次理学测试成功，那么真的一二级标题联动就正式写完了！', '2019-04-01 16:09:43', '', NULL, 51, 5, 'root', '2019-04-08 16:09:43', '8天19小时19分钟之前');
INSERT INTO `post` VALUES (7, 'root', 'ajax出问题了', 16, '全职', 2, '后台我将两个list放到了一个map里，但是问题是我想把其中一个list的值渲染到前台的某个div中，因为那个div本身就已经是个list循环出来的(是上一个页面点击渲染的)，但是ajax返回之后 我不知道 应该怎么写下面是前台的代码:(这个list本来是有值的 )', '2019-04-09 14:00:01', '', NULL, 27, 1, '吹不散眉弯', '2019-04-09 15:10:06', '1小时56分钟之前');
...
INSERT INTO `reply` VALUES (6, 2, 'root', '那本书我也看了，我打算明天再看一遍', '2019-04-08 14:40:15', 1, '8天20小时49分钟之前');
INSERT INTO `reply` VALUES (7, 2, 'root', '那本书我也看了，我打算明天再看一遍', '2019-04-08 14:41:05', 2, '8天20小时48分钟之前');
...
INSERT INTO `reply` VALUES (10, 2, '一首歌从深情唱', '现在测试一下时间的更新看看对不对', '2019-04-08 16:54:52', 3, '8天18小时34分钟之前');
INSERT INTO `reply` VALUES (11, 2, '一首歌从深情唱', '我来更新一下时间，看看时间对不对', '2019-04-08 17:27:07', 3, '8天18小时2分钟之前');
INSERT INTO `reply` VALUES (12, 3, '一首歌从深情唱', '现在来测试一下时间差值是否正确！', '2019-04-08 18:06:20', 2, '22小时20分钟之前');
INSERT INTO `reply` VALUES (13, 4, '一首歌从深情唱', '真是个悲伤的故事，时间测试还是没有完全成功！', '2019-04-08 18:16:30', 1, NULL);
INSERT INTO `reply` VALUES (14, 4, '吹不散眉弯', '我感觉如果真的可能的话，或许我们可以调整一下思路，重新把时间好好划分一下，这样的话应该就不会有太大问题', '2019-04-09 09:08:22', 2, NULL);
INSERT INTO `reply` VALUES (15, 2, '吹不散眉弯', '就奇怪不知道为啥感觉效率很慢呢，', '2019-04-09 09:18:06', 4, '8天2小时11分钟之前');
INSERT INTO `reply` VALUES (16, 2, 'root', '测试', '2019-04-09 09:53:51', 5, '8天1小时35分钟之前');
INSERT INTO `reply` VALUES (17, 2, 'root', '测试下时间是否是正确的', '2019-04-09 09:55:55', 6, '8天1小时33分钟之前');
INSERT INTO `reply` VALUES (18, 7, '吹不散眉弯', '测试一下距离！', '2019-04-09 15:10:06', 1, '2小时0分钟之前');
