...
INSERT INTO `post` VALUES ('2', '2', '吹不散眉弯', '今天学到了一点新的东西，跟同学们分享一下', '9', '工学', '1', '今天学习了设计模式，发现里面很多东西都非常值得思考，今天刚刚学习了策略模式，感觉非常不错，希望大家都可以学习一下，', '2019-03-29 10:38:08', '51d89138-372b-42e7-91c9-78afef1c52a3.PNG', '', '315', '14', '吹不散眉弯', '2019-04-26 16:45:44', '1小时24分钟之前');
INSERT INTO `post` VALUES ('3', '2', '吹不散眉弯', '谈谈今天的一些感受吧', '9', '工学', '1', '今天温度挺低的，本来就穿的不厚，结果感觉今天脑子更疼， 不知道大家有没有啥推荐的网站听听音乐啥的吗,http://www.baidu.com', '2019-04-01 09:07:44', 'ab35664c-3d1d-4046-98de-5e3de09ce992.PNG', '', '47', '2', '一首歌从深情唱', '2019-04-08 18:06:20', '18天0小时3分钟之前');
INSERT INTO `post` VALUES ('4', '1', 'root', 'B 站的同学，你们能不能不要在移动端主页投毒了？', '10', '理学', '1', '每次手机重装系统之后去 B 站主页( https://m.bilibili.com/index.html) 下客户端，都会下到国际版。只能安装客户端后去问客服要国内的客户端，再重新装一次。​为什么移动端首页不能改成国内的？国际版的没有免流服务，我要它何用？', '2019-04-01 09:09:08', '', '', '40', '2', '吹不散眉弯', '2019-04-09 09:08:22', '17天9小时1分钟之前');
INSERT INTO `post` VALUES ('5', '2', '吹不散眉弯', '测试下管理学代码', '12', '管理学', '1', '如果管理学代码测试成功！，那么今天就完成了很大的一部分工作！加油 2019/4/1', '2019-04-01 11:27:28', '', null, '117', '2', '吹不散眉弯', '2019-04-26 09:25:21', '8小时44分钟之前');
INSERT INTO `post` VALUES ('6', '2', '吹不散眉弯', '理学的二次测试', '10', '理学', '1', '如果这次理学测试成功，那么真的一二级标题联动就正式写完了！', '2019-04-01 16:09:43', '', null, '67', '6', '吹不散眉弯', '2019-04-26 14:02:41', '4小时7分钟之前');
...
-- Records of reply
-- ----------------------------
INSERT INTO `reply` VALUES ('1', '6', '2', '吹不散眉弯', '我感觉这次测试会成功!', '2019-04-02 17:11:30', '1', '23天22小时17分钟之前');
INSERT INTO `reply` VALUES ('2', '6', '2', '吹不散眉弯', '这测试的第二条回复 看看会不会成功', '2019-04-02 17:39:52', '2', '23天21小时49分钟之前');
INSERT INTO `reply` VALUES ('3', '6', '2', '吹不散眉弯', '现在进行第三条回复测试', '2019-04-02 18:04:21', '3', '23天21小时24分钟之前');
INSERT INTO `reply` VALUES ('4', '6', '2', '吹不散眉弯', '第四次测试看看到底哪里有问题', '2019-04-02 18:07:16', '4', '23天21小时21分钟之前');
INSERT INTO `reply` VALUES ('5', '6', '2', '吹不散眉弯', '第五次测试！，这次一定要成功啊！', '2019-04-02 18:10:02', '5', '23天21小时18分钟之前');
INSERT INTO `reply` VALUES ('6', '2', '1', 'root', '那本书我也看了，我打算明天再看一遍', '2019-04-08 14:40:15', '1', '18天3小时6分钟之前');
INSERT INTO `reply` VALUES ('7', '2', '1', 'root', '那本书我也看了，我打算明天再看一遍', '2019-04-08 14:41:05', '2', '18天3小时5分钟之前');
INSERT INTO `reply` VALUES ('8', '3', '3', '一首歌从深情唱', '歌曲的话，可以去51sing里面好像还有伴奏可以随便下，感觉挺不错的，你可以去试试啊，然后我现在平常用QQ音乐听，自己用的大王卡，感觉用QQ音乐听非常好', '2019-04-08 15:33:01', '1', '18天2小时14分钟之前');
INSERT INTO `reply` VALUES ('9', '5', '3', '一首歌从深情唱', '哈哈，测试差不多可以结束了，真正的实现了相应的功能操作，和应有的逻辑，不负初心，不负己！', '2019-04-08 15:35:53', '1', '17天17小时52分钟之前');
INSERT INTO `reply` VALUES ('10', '2', '3', '一首歌从深情唱', '现在测试一下时间的更新看看对不对', '2019-04-08 16:54:52', '3', '18天0小时52分钟之前');
INSERT INTO `reply` VALUES ('11', '2', '3', '一首歌从深情唱', '我来更新一下时间，看看时间对不对', '2019-04-08 17:27:07', '3', '18天0小时19分钟之前');
INSERT INTO `reply` VALUES ('12', '3', '3', '一首歌从深情唱', '现在来测试一下时间差值是否正确！', '2019-04-08 18:06:20', '2', '17天23小时40分钟之前');
...
INSERT INTO `reply` VALUES ('15', '2', '2', '吹不散眉弯', '就奇怪不知道为啥感觉效率很慢呢，', '2019-04-09 09:18:06', '4', '17天8小时28分钟之前');
INSERT INTO `reply` VALUES ('16', '2', '1', 'root', '测试', '2019-04-09 09:53:51', '5', '17天7小时53分钟之前');
INSERT INTO `reply` VALUES ('17', '2', '1', 'root', '测试下时间是否是正确的', '2019-04-09 09:55:55', '6', '17天7小时51分钟之前');
...
INSERT INTO `reply` VALUES ('26', '2', '3', '一首歌从深情唱', '测试一下，回复为空和不为空的区别', '2019-04-23 13:41:04', '7', '3天4小时5分钟之前');
INSERT INTO `reply` VALUES ('27', '9', '3', '一首歌从深情唱', '今天再去看一眼，看看老师在不在办公室~', '2019-04-24 09:36:35', '7', '1天5小时9分钟之前');
INSERT INTO `reply` VALUES ('28', '5', '2', '吹不散眉弯', '我先来测试一下，不@人试一试！', '2019-04-26 09:15:33', '2', '12分钟之前');
INSERT INTO `reply` VALUES ('29', '5', '2', '吹不散眉弯', '啊啊啊啊啊', '2019-04-26 09:25:21', '2', '3分钟之前');
INSERT INTO `reply` VALUES ('30', '6', '2', '吹不散眉弯', '我来测试一下是不是能成功', '2019-04-26 14:02:41', '6', '1小时26分钟之前');
INSERT INTO `reply` VALUES ('31', '2', '2', '吹不散眉弯', '我就是为了测试看看动画', '2019-04-26 15:34:19', '8', '2小时12分钟之前');
INSERT INTO `reply` VALUES ('32', '2', '2', '吹不散眉弯', '我就是为了测试看看动画', '2019-04-26 15:34:21', '9', '2小时12分钟之前');
INSERT INTO `reply` VALUES ('33', '2', '2', '吹不散眉弯', '我就是为了测试看看动画', '2019-04-26 15:34:24', '10', '2小时12分钟之前');
INSERT INTO `reply` VALUES ('34', '2', '2', '吹不散眉弯', '我就是为了测试看看动画', '2019-04-26 15:34:27', '11', '2小时12分钟之前');
INSERT INTO `reply` VALUES ('35', '2', '2', '吹不散眉弯', '我就是为了测试看看动画', '2019-04-26 15:34:30', '12', '2小时12分钟之前');
INSERT INTO `reply` VALUES ('36', '2', '2', '吹不散眉弯', '我就是为了测试看看动画', '2019-04-26 15:34:34', '13', '2小时12分钟之前');
INSERT INTO `reply` VALUES ('37', '2', '2', '吹不散眉弯', '@root 我来试试到底有没有给你发信息成功啊 如果成功！信息发送功能就完成了 ！哈哈哈', '2019-04-26 16:45:44', '14', '1小时1分钟之前');
...
CREATE TABLE `unread` (
  ...
  `infocome_id` int(12) DEFAULT NULL COMMENT '发送信息者的id',
  PRIMARY KEY (`id`)
...
INSERT INTO `unread` VALUES ('2', '1', '我来试试到底有没有给你发信息成功啊 如果成功！信息发送功能就完成了 ！哈哈哈', '2');
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('1', '2', '541513250153', 'root', 'admin', '13222222222', '软件学院', '1', '息县三中', '男', null, '1', '0', '0');
