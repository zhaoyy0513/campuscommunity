...
INSERT INTO `focus` VALUES ('11', '5', '2;');
...
CREATE TABLE `post` (
  ...
  `post_content_img` varchar(40) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL COMMENT '发帖附带的图片',
  `post_user_icon` varchar(30) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL COMMENT '发帖人照片',
  `post_click_count` int(10) DEFAULT '0' COMMENT '帖子点击数',
  `post_reply_count` int(10) unsigned DEFAULT '0' COMMENT '帖子回复数',
  `post_last_reply` varchar(20) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL COMMENT '帖子最后回复者',
  `post_last_reply_time` varchar(20) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL COMMENT '帖子最后回复时间',
  `post_last_reply_time_simple` varchar(20) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL COMMENT '帖子最后回复时间(差值)用来显示在页面上',
  PRIMARY KEY (`id`),
...
CREATE TABLE `postcollection` (
  ...
  `post_id` varchar(40) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL COMMENT '帖子索引id',
  PRIMARY KEY (`id`)
...
CREATE TABLE `reply` (
  ...
  `reply_time_simple` varchar(20) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL COMMENT '回复时间简写',
  PRIMARY KEY (`id`),
  KEY `postid` (`post_id`)
...
CREATE TABLE `unread` (
  ...
  `infocome_time` varchar(20) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL COMMENT '回复时间',
...
INSERT INTO `user` VALUES ('2', '2', '541513250132', '吹不散眉弯', '111', '18539270747', '软件学院', '2', '息县第一高级中学', '男', null, '11', '2', '1');
INSERT INTO `user` VALUES ('3', '1', '541513250222', '一首歌从深情唱', '111', '15299999999', '计算机与通信工程学院', '1', '息县三中', '男', null, '1', '1', '2');
INSERT INTO `user` VALUES ('4', '1', '544513250136', '朝气蓬勃', '111', '15638053724', '软件学院', '1', '息县三中', '男', null, '3', '5', '1');
INSERT INTO `user` VALUES ('5', '2', '541513250100', '深蓝梦境', '111', '18539270789', '软件学院', '5', '刘华', '男', null, '0', '1', '1');
INSERT INTO `user` VALUES ('6', '1', '541513250101', 'asd', 'asd', '18539270789', '经济与管理学院', '5', 'ss', '男', null, '0', '0', '0');
